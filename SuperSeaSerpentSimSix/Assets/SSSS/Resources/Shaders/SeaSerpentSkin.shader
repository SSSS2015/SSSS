...
////// Lighting:
                ...
                float3 finalColor = ((_EyeColor.rgb*_DiffuseTexture_var.a*_EyeBrightness)+(_DiffuseTexture_var.rgb*_PaperTexture_var.rgb*_LightingRamp_var.rgb));
                return fixed4(finalColor,1);
            }
            ENDCG
        }
