...
////// Lighting:
                ...
                float node_626 = (1.0 - length(node_363.ba));
                ...
                float3 node_474 = (_Color.rgb*_Texture_with_alpha_var.rgb*_PaperTexture_var.rgb*(saturate((length(node_363.rg)*2.9+0.1))+_PaperTexture_var.rgb));
                float3 finalColor = saturate((1.0-((1.0-node_474)/node_626)));
