...
////// Lighting:
                ...
                float3 finalColor = saturate((1.0-((1.0-(_Color.rgb*_Texture_with_alpha_var.rgb*_PaperTexture_var.rgb*(saturate((length(node_363.rg)*1.9+0.1))+_PaperTexture_var.rgb)))/((1.0 - length(node_363.ba))*0.6+0.4))));
