...
////// Lighting:
                ...
                float3 finalColor = lerp(float3(0.7720588,0.8962475,1),(_Color.rgb*_Texture_with_alpha_var.rgb*_PaperTexture_var.rgb),saturate(((node_4483-distance(_WorldSpaceCameraPos,i.posWorld.rgb))/(node_4483-26.0))));
